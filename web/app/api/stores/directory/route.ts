...
import { nationwideStoreDirectory, storeDirectoryCompleteness } from '@/lib/store-directory';
...
export async function GET(request: Request) {
  ...
  const filtered = nationwideStoreDirectory.filter((entry) => entry.isActive)
